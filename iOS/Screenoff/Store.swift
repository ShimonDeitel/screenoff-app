...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total night entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("screenoff_entries.json")
        settingsURL = support.appendingPathComponent("screenoff_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
